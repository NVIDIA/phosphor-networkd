...
int main(int argc, char** argv)
{
    ...
    if (eidInt < 0)
    {
        exitWithError("EID value should be greater than or equal to 0", argv);
    }
    ...
    if (packageInt > 7)
    {
        exitWithError("package value should be less than or equal to 7", argv);
    }
    ...
    if (channelInt > 31)
    {
        exitWithError("channel value should be less than or equal to 31", argv);
    }
    ...
    if (cmdInt < 0)
    {
        exitWithError("cmd value should be greater than or equal to 0", argv);
    }
    if (cmdInt > 96)
    {
        exitWithError("cmd value should be less than or equal to 96", argv);
    }
    ...
    {
        exitWithError("exception happened when sending ncsi command", argv);
    }
